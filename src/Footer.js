             ...
             <div className="col-2 mt-2">
                <h6 className="">Handige links</h6>
                    <ul className="useful-links">
                        <li className="useful-links-list-item"><a href="pokemon.com" className="link-light">Terms of Use</a></li>
                        <li className="useful-links-list-item"><a href="pokemon.com" className="link-light">Privacy</a></li>
                        <li className="useful-links-list-item"><a href="pokemon.com" className="link-light">Notice</a></li>
                        <li className="useful-links-list-item"><a href="pokemon.com" className="link-light">Cookie Page</a></li>
                        <li className="useful-links-list-item"><a href="pokemon.com" className="link-light">Legal Info</a></li>
                        <li className="useful-links-list-item"><a href="pokemon.com" className="link-light">Security</a></li>
